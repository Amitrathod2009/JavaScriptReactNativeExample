    ...
    return (
        <View style={{ flex: 1, backgroundColor: "white" }}>
            <View style={[styles.topView]}>
                ...
                <TouchableOpacity><Text style={[styles.centerTexts, { marginHorizontal: 50 }]}>Discover Inside Tab Shown</Text></TouchableOpacity>
            </View>
            ...
            {/* <View style={styles.bottomView} >
                ...
                <TouchableOpacity style={[styles.bottomButton]}><Text style={[styles.buttonText]}>Preference</Text></TouchableOpacity>
